...
class FavoritesController extends AutoDisposeNotifier<void> {
  ...
  Future<void> toggleTrackFavorite(Track track, bool isCurrentlyFavorite) async {
  ...
  Future<void> toggleArtistFollow(String id, String name, String? imageUrl, bool isCurrentlyFollowed) async {
