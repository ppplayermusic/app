...
class DiscoverSection {
  ...
  factory DiscoverSection.fromJson(Map<String, dynamic> json) => DiscoverSection(
        ...
        type: DiscoverSectionType.values.firstWhere((e) => e.name == json['type']),
        tracks: (json['tracks'] as List?)?.map((t) => Track.fromJson(t as Map<String, dynamic>)).toList() ?? [],
        artists: (json['artists'] as List?)?.map((a) => Artist.fromJson(a as Map<String, dynamic>)).toList() ?? [],
      );
}
...
class DiscoverContent {
  ...
  factory DiscoverContent.fromJson(Map<String, dynamic> json) => DiscoverContent(
        sections: (json['sections'] as List?)?.map((s) => DiscoverSection.fromJson(s as Map<String, dynamic>)).toList() ?? [],
