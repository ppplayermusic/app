...
void main() {
  ...
  group('Clear Cache Regression Tests', () {
    test('CatalogCacheRepository.clearAll() clears L1 and L2 and providers are invalidated', () async {
      // 1. Setup Data Layer
      ...
      invalidateCatalogProviders(container); // Wait, invalidateCatalogProviders expects WidgetRef, but container is ProviderContainer! We can't directly use invalidateCatalogProviders with ProviderContainer because they have different interfaces, but ProviderContainer has `invalidate()`. We can just write a wrapper or use Ref.
