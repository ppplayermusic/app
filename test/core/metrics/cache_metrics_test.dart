...
void main() {
  ...
  test('concurrent requests increment dedupHits by callers joining in-flight', () async {
    final futures = List.generate(10, (index) => repository.watchOrFetch<String>(
  ...
  test('L2 hit works across process restarts without L1', () async {
    ...
    await repositoryB.watchOrFetch<String>(
      key: 'restart_test',
      resourceType: ResourceType.artist,
