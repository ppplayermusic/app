...
void main() {
  test('V9 to V10 migration correctly adds id to playlist_tracks and preserves relationships', () async {
    ...
    final pTracks = await (db.select(db.playlistTracks)..orderBy([(t) => OrderingTerm(expression: t.position, mode: OrderingMode.asc)])).get();
